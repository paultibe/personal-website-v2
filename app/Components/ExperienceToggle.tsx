...
const ExperienceToggle = ({
  ...
  return (
    <div className="my-4">
      <div
        className="flex items-center justify-between px-4 md:px-48 cursor-pointer rounded-lg shadow-md shadow-gray-300/50 hover:shadow-lg transition-shadow duration-300 ease-in-out"
